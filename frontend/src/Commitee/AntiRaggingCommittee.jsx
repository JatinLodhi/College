  ...
  const sections = [
    {
      ...
      description:
        'The Anti-Ragging Committee at Rewar College is constituted to ensure a ragging-free campus. It promotes awareness about anti-ragging policies, investigates complaints, and takes preventive measures to uphold student safety and dignity.',
      icon: '🛡️'
    },
    {
      ...
      items: [
        {
          ...
          members: ['Dr. Meera Sinha'],
          color: 'primary'
        },
        {
          subtitle: 'Faculty Representatives',
          members: ['Prof. Sanjay Kulkarni', 'Prof. Kavita Rao'],
          color: 'success'
        },
        {
          subtitle: 'Student Representatives',
          members: ['Rohan Gupta', 'Sneha Patil', 'Amit Joshi', 'Neha Bansal'],
          color: 'info'
        }
      ],
      icon: '👥'
    },
    {
      ...
      description:
        'The Committee conducts orientation programs, awareness campaigns, surprise checks in hostels, and grievance redressal sessions. It also ensures all students sign an anti-ragging affidavit.',
      icon: '📋'
    },
    {
      title: 'Anti-Ragging Policies',
      description: 'Our college strictly follows UGC guidelines on anti-ragging. All students must sign an anti-ragging affidavit, and any violation is dealt with severe consequences including suspension or expulsion.',
      icon: '📜'
    }
  ];
                ...
                <div className="row text-center">
                  <div className="col-md-4 mb-3">
                    <div className="contact-item">
                      ...
                      <small>antiragging@college.edu</small>
                    </div>
                  </div>
                  <div className="col-md-4 mb-3">
                    <div className="contact-item">
