        ...
        <Row className="gy-4 align-items-stretch justify-content-between text-center" style={{borderBottom: '1px solid rgba(255,255,255,0.08)'}}>
          ...
          <Col lg={4} md={6} className="mb-4 flex-grow-1 d-flex flex-column align-items-center justify-content-center border-end border-light-subtle">
            ...
            <div className="contact-info w-100 align-items-center">
              <div className="contact-item justify-content-center w-100"><FaMapMarkerAlt className="contact-icon me-2" /><span>NH-11, Sikar Road, Rewari, Haryana, India</span></div>
              <div className="contact-item justify-content-center w-100"><FaEnvelope className="contact-icon me-2" /><span>info@rewarcollege.edu.in</span></div>
              <div className="contact-item justify-content-center w-100"><FaPhoneAlt className="contact-icon me-2" /><span>+91 98765 43210</span></div>
